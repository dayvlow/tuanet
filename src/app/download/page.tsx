            ...
            <Section>
                <div className="max-w-5xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <Card variant="outline" className="p-8 border-white/15">
                        <h3 className="text-2xl font-black uppercase tracking-tight mb-4">Нужен доступ?</h3>
                        <p className="text-lg text-white/60 mb-6">Открой кабинет или свяжись с поддержкой, если нужен новый доступ или помощь со входом.</p>
                        <Link
                            href="/login"
                            className={cn(
