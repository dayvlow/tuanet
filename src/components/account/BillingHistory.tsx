        ...
        <section className="rounded-[32px] border-2 border-zinc-800 bg-zinc-900/70 p-8 text-white">
            <div className="flex flex-col gap-6">
                <div>
                    ...
                    <p className="text-base font-medium leading-relaxed text-white/40">Все пополнения и статусы оплат</p>
                </div>
                ...
                {state === "empty" && (
                    <div className="rounded-3xl border-2 border-white/10 bg-white/5 p-8 text-center">
                        ...
                        <p className="mt-3 text-base font-medium leading-relaxed text-white/40">После первого пополнения история появится здесь</p>
                    </div>
                )}
