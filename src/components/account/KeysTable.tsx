        ...
        <section className="rounded-[32px] border-2 border-zinc-800 bg-zinc-900/70 p-8 text-white">
            <div className="flex flex-col gap-6">
                <div>
                    ...
                    <p className="text-base font-medium leading-relaxed text-white/40">Управление ключами подключения и быстрый контроль доступа.</p>
                </div>
                                    ...
                                    {rows.length === 0 && (
                                        <tr className="border-t border-white/10">
                                            <td colSpan={5} className="px-4 py-8 text-center text-white/50">
                                                По текущим фильтрам ключи не найдены.
                                            </td>
                                        </tr>
                                    )}
                                    {rows.map((key) => (
